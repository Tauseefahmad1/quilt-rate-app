...
class GetPostService {
  static Future getpostNow({required BuildContext context}) async {
    try {
      ...
      var request = http.MultipartRequest('GET', Uri.parse(getpostsurl));
  ...
  static Future getfollowerpostNow({required BuildContext context}) async {
    try {
      var headers = {'Authorization': 'Bearer $token'};
      var request = http.MultipartRequest('GET', Uri.parse(getfollowingurl));
