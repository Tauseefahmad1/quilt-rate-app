...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.fluttertinderswipe.flutter_tinder_swipe.FlutterTinderSwipePlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_tinder_swipe, com.fluttertinderswipe.flutter_tinder_swipe.FlutterTinderSwipePlugin", e);
    }
    try {
